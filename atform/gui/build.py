...
class Dialog(simpledialog.Dialog):  # pylint: disable=too-many-instance-attributes
    ...
    def body(self, master):
        ...
        # Ensure all futures are cancelled when the window is closed to handle
        # cases when the dialog is closed via the window manager instead of
        # the close button.
        master.bind("<Destroy>", self._cancel_futures)
    ...
    def _cancel_futures(self, _event=None):
        ...
        # Clear the set of futures so any further calls to this method
        # don't cancel the futures again.
        self.futures = {}
