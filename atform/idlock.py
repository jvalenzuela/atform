...
def check_ids(current_tests, old_tests):
    ...
    The intent is to detect tests that have been inadvertently shifted, i.e.,
    the same title with a different ID.
    """
    # IDs that exist only in the lock file are considered new tests.
