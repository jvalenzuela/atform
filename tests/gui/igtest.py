...
class Preview(InteractiveGuiTestCase):
    ...
    def test_title(self):
        """Confirm correct preview title display."""
        atform.add_test("This is the title")
        self.start_preview()

    def test_objective(self):
        """Confirm correct Preview objective display."""
        atform.add_test(
            "title",
            objective="""
    ...
    def test_references(self):
        """Confirm correct Preview references display."""
    ...
    def test_location(self):
        """Confirm preview location specified in objective."""
