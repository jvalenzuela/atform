...
class Base(unittest.TestCase):
    ...
    def setUp(self):
        utils.reset()
        self.root = tk.Tk()
        self.tl = atform.gui.testlist.TestList(self.root)
...
class AddTest(Base):
    ...
    def test_duplicate(self):
        ...
        self.tl.add_test((1,))
        self.tl.add_test((1,))
        self.assertEqual(1, len(self.tl.tree.get_children()))
...
class Clear(Base):
    ...
    def test_removal(self):
        ...
        self.tl.clear()
        self.assertEqual(0, len(self.tl.tree.get_children()))
...
class Title(Base):
    """Tests for the section and test title columns."""
...
class ExpandAll(Base):
    ...
    def test_all_closed(self):
        ...
        utils.click_button(self.tl, "expand_all")
...
class CollapseAll(Base):
    ...
    def test_all_closed(self):
        ...
        self.set_open((2,), tk.FALSE)
        self.set_open((2, 1), tk.FALSE)
        utils.click_button(self.tl, "collapse_all")
...
class SelectAll(Base):
    ...
    def test_initial_none(self):
        ...
        utils.click_button(self.tl, "select_all")
...
class UnselectAll(Base):
    ...
    def test_initial_none(self):
        ...
        self.tl.tree.selection_set()
        utils.click_button(self.tl, "unselect_all")
...
class InvertSelection(Base):
    ...
    def test_initial_none(self):
        ...
        self.tl.tree.selection_set()
        utils.click_button(self.tl, "invert_selection")
        self.assertEqual(
            (
                (1, 1, 1),
                (1, 1, 2),
