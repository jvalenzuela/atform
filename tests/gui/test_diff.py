...
class TestLabel(DiffBase):
    ...
    def test_change_label_test(self):
        ...
        self.generate_diff()
        self.assert_diff(changed={(2,)}, same={(1,), (3,)})
