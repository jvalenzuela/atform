...
# Output
#
# In addition to the atform.generate() function call, any code
# generating output, such as the CSV file here, must also be
# enclosed in the if condition testing the __name__ variable and
# located in the top-level script.
######################################################################
